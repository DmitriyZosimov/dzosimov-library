...
public class BookDaoSpringJdbc implements BookDao, InitializingBean {
  ...
  @Override
  public Integer addBookForReader(Integer bookId, Integer readerId) {
  ...
  @Override
  public Integer removeAllBooksFromReader(Integer readerId) {
    LOGGER.info("removeReaderFromBook(BookDto) was started");
    LOGGER.debug("readerId={}", readerId);
    MapSqlParameterSource sqlParameterSource = new MapSqlParameterSource();
    sqlParameterSource.addValue("readerId", readerId);
    return namedParameterJdbcTemplate
        .update(removeReaderForBooksSql, sqlParameterSource.getValues());
  }
  ...
  @Override
  public Integer removeBookFromReader(Integer bookId, Integer readerId) {
    LOGGER.info("removeBookFromReader was started");
    LOGGER.debug("bookId={}, readerId={}", bookId, readerId);
    MapSqlParameterSource sqlParameterSource = new MapSqlParameterSource();
    sqlParameterSource.addValue("bookId", bookId);
    sqlParameterSource.addValue("readerId", readerId);
