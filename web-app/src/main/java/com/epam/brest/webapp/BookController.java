...
public class BookController {
  ...
  @Autowired
  public BookController(BookService bookService, LocaleResolver localeResolver,
  ...
  /**
   * Goto a book page with model attribute "isNew" is false and with found book by identification.
   *
  ...
  public String deleteBook(@PathVariable("id") @Min(1) Integer bookId, Model model,
