...
public class CustomControllerExceptionHandler {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(CustomControllerExceptionHandler.class);

  private final LocaleResolver localeResolver;
  private final MessageSource messageSource;

  public CustomControllerExceptionHandler(LocaleResolver localeResolver,
  ...
  public ModelAndView handlerHttpClientErrorException(HttpClientErrorException ex,
  ...
  private ModelAndView renderErrorPage(HttpStatus status, HttpServletRequest request,
      String message) {
    ModelAndView mav = new ModelAndView();
